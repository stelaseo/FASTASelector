...
namespace FASTASelector.Data
{
    ...
    {
        private sealed class TaskSequenceSelectAll : Task
        {
            ...
            public override bool Initialize( Controller controller )
            {
                ...
                if( controller.Sequences.Count > 0 )
                {
                    ...
                    App.Log( App.DEFAULT, "Selected all sequences" );
                    return true;
                }
                return false;
            }
            ...
            public override void Undo( Controller controller )
            {
                ...
                App.Log( App.DEFAULT, "Reverted selections in the sequence list to the state prior to selecting all sequences" );
            }
